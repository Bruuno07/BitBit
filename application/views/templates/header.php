    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item ">
            <a type="button" href="<?php echo site_url('') ?>" class="btn btn-dark mr-1">Inicio</a>
          </li>
          <li class="nav-item">
            <a type="button" href="<?php echo site_url('Contactanos') ?>" class="btn btn-dark mr-1">Contactanos</a>
          </li>
          <li class="nav-item">
            <a type="button" href="<?php echo site_url('Nosotros') ?>" class="btn btn-dark mr-1">Quienes Somos</a>
          </li>

        </ul>

        <a type="button" href="<?php echo site_url('login') ?>" class="btn btn-info mr-1 ">Inicar sesión</a>
