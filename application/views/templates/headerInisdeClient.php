    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item ">
            <a type="button" href="<?php echo site_url('anuncios') ?>" class="btn btn-dark mr-1">Anuncios</a>
          </li>
          <!-- <li class="nav-item ">
            <a type="button" href="<?php echo site_url('nuevareparacion') ?>" class="btn btn-outline-secondary mr-3">Nueva reparación</a>
          </li>  -->
        </ul>
        <a class="text text-white mr-5" href="<?php echo site_url('passwdchange') ?>"><img src="<?php echo base_url("assets/img/config.png") ?>" />Configuración</a>
